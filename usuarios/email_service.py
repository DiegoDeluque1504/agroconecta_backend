...
def enviar_correo_recuperacion(destinatario, nombre, enlace_recuperacion):
    """Correo de recuperacion de contrasena (falla si no se puede enviar)."""
    html = f'''
        <!DOCTYPE html>
        <html lang="es">
        ...
        <body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f4f4f4;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f4;padding:40px 0;">
            <tr><td align="center">
              <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.1);">
                <!-- Header verde -->
                <tr>
                  <td style="background:linear-gradient(135deg,#0f4c2a,#2d9e5f);padding:32px 40px;text-align:center;">
                    <h1 style="color:#ffffff;margin:0;font-size:22px;font-weight:700;">AgroConecta</h1>
                    <p style="color:#a7f3d0;margin:6px 0 0;font-size:14px;">Recuperacion de Contrasena</p>
                  </td>
                </tr>
                <!-- Cuerpo -->
                <tr>
                  <td style="padding:36px 40px;">
                    <h2 style="color:#1f2937;font-size:18px;margin:0 0 12px;">Hola, {nombre}</h2>
                    <p style="color:#4b5563;font-size:15px;line-height:1.6;margin:0 0 20px;">
                      Recibimos una solicitud para restablecer la contrasena de tu cuenta en
                      <strong>AgroConecta</strong>. Si fuiste tu, haz clic en el boton de abajo.
                    </p>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="padding:8px 0 28px;">
                          <a href="{enlace_recuperacion}"
                             style="display:inline-block;background:linear-gradient(135deg,#0f4c2a,#2d9e5f);
                                    color:#ffffff;text-decoration:none;padding:14px 36px;
                                    border-radius:8px;font-size:15px;font-weight:600;
                                    box-shadow:0 4px 14px rgba(15,76,42,0.4);">
                ...
                <tr>
                  <td style="background:#f9fafb;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
                    <p style="color:#9ca3af;font-size:12px;margin:0;">
                      &copy; 2025 AgroConecta &mdash; La Guajira, Colombia
                    </p>
                  </td>
                </tr>
              </table>
    ...
    return _enviar_correo_resend(
        destinatario,
        'Restablece tu contrasena en AgroConecta',
        html,
        raise_on_error=True,
    )
