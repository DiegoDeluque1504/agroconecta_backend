...
# Configuración de Cloudinary (las credenciales van aquí después)
...
SIMPLE_JWT = {
    ...
    # Genera un nuevo token de refresco cada vez que se refresca el acceso
    'ROTATE_REFRESH_TOKENS': True,
    # Invalida el token de refresco anterior cuando se rota
    'BLACKLIST_AFTER_ROTATION': False,
    # El campo que se usa como identificador en el token
    'USER_ID_FIELD': 'id',
